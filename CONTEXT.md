...
- **Hermes Kanban** — Task and DAG orchestrator (To-do / In Progress / Done) at `kanban.thangvq95.page`.
...
| **3. Runtime State** | Execution state, task status, logs | Hermes Kanban + GitHub Issues |
| **4. Documentation** | Human-facing architecture, onboarding | `docs/PRD.md`, `docs/architecture/*` |

Pipeline: `Brainstorm → writing-plans → Hermes executes → Hermes Kanban → docs update`
