...
export default function RepoDetailPage() {
  ...
  const handleCreateAndAssignCategory = useCallback(
    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
      ...
      >
        ...
        >
          ...
          {repoData.language &&
            repoData.language.toLowerCase() !== "unknown" && (
          ...
          {isAddingNewCat ? (
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <option value="new" className="text-green-400 font-bold">
                  + Create New...
                </option>
              </select>
            </div>
      ...
      >
        ...
        (!repoData.latest_release_tag ||
          repoData.latest_release_tag.toLowerCase() === "unknown") ? (
