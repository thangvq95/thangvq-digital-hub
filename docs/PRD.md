...
| AI Orchestration | **Hermes + GitNexus + Superpowers Skills** | Planning, execution, context |
...
graph TB
    ...
    L2 -->|Hermes executes| L3["3. Runtime State"]
    L3 -->|results feed back| L4["4. Documentation"]
...
| **3. Runtime State** | Execution state, task status, logs | GitHub Projects + GitHub Issues |
...
| Component | Role |
|---|---|
| **Superpowers Skills** | Planning & design — brainstorming, writing-plans, architecture decomposition |
